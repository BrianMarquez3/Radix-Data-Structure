...
//Función de utilidad para leer una cookie.
...
// Función de utilidad para escribir una cookie
...
// Mueve estos  espacio globales animación
var objectManager;
...
/*tiempo que dura la aminacion*/
function timeout()
{
	/**TIEMPO DE ESPERA EN LAS TRANSICIONES*/
    timer = setTimeout('timeout()', 15); 
...
/*movimiento*/
	...
	this.startNextBlock = function()
	{
		...
		this.currentBlock = [];
		var undoBlock = []
			//ingresar varios datos en el arbol
		...
		{			
			...
			//Linesas conectoras con los circulos
			...
			//muestra el conjunto de caracterres en pantalla
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//  Comienza una nueva animación. Los comandos de parámetros de entrada es una matriz de cadenas,
    // que representa la animación para comenzar
	...
	this.finishUndoBlock = function(undoBlock)
	{
		...
		this.doingUndo = false;
			...
			//Si estamos al final de la animación ...
	...
	this.undoLastBlock = function()
	{
		...
		if (this.undoAnimationStepIndices.length == 0)
		{
			...
			//Nada en la pila de deshacer. Regreso
			return;
