///////////////////////////////////////////////////////////////////////////////////////////////////////////
/**********************************************RADIX - ANIMATEDCIRCLE.JS**********************************/
///////////////////////////////////////////////////////////////////////////////////////////////////////////

var AnimatedCircle = function(objectID, objectLabel) //funcion animacion circulo
{
...
{
	return this.getHeadPointerAttachPos(fromX, fromY);	//Puntero de Cabezera
}


AnimatedCircle.prototype.getWidth = function() //obtener ancho
{
...
AnimatedCircle.prototype.draw = function(ctx)
{
	...
	/**************************************** muestra las letras en lo circulos************************************/
